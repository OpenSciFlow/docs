...
2. `../reference/protocol-status.md`
   - 当前已经做到什么，哪些还没有做到。
3. `../reference/manifest-field-policy.md`
   - 为什么关键 manifest 字段必须显式声明。
4. `../concepts/plugin.md`
   - 什么是 `opensciflow.yaml`。
5. `../concepts/workflow-template.md`
   - workflow template 解决什么问题。
6. `../concepts/local-agent.md`
   - 本地 Agent 应该如何执行，哪些事情不能做。
7. `../concepts/reproducibility.md`
   - 为什么每次运行都要留下 run record。
8. `../reference/v0.2-reviewed-wrapper-rfc.md`
